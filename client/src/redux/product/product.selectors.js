...
export const selectProducts = createSelector(selectState, (product) => product.products);
...
export const selectAccessoriesProducts = createSelector(selectProducts, (products) =>
  products.filter((p) => p.category === '607b4ab76a8ae23bbfd5a9dd'),
);

export const selectNewArrivalsProducts = createSelector(selectProducts, (products) =>
