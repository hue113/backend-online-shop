...
const ProductCardSmall = ({ product }) => {
  const { name, image, sku, price, variation } = product;
      ...
      <div className="row">
        ...
        <div className="price col-8 pr-0 my-auto">
          ...
          {variation[0].discount === 0 ? (
            <span className="mr-3">${variation[0].price.toFixed(2)}</span>
          ) : (
            <div>
              <span className="mr-3 old-price">${variation[0].price.toFixed(2)}</span>
