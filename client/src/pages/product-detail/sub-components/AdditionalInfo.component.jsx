    ...
    <div className="section additional-info w-100">
      <div className="container">
        <Tab.Container defaultActiveKey="additionalInfo">
          ...
          <Nav variant="pills" className="top-bar p-2 d-flex justify-content-center">
            <Nav.Item>
            ...
            <Nav.Item>
              <Nav.Link eventKey="productReviews" id="reviewsTab">
                Reviews
              </Nav.Link>
            </Nav.Item>
          </Nav>
          ...
          <Tab.Content className="content m-5">
            {/* Additional Info Tab */}
            <Tab.Pane eventKey="additionalInfo">
              <div className="additionalInfo">
                ...
                <div className="py-2">
                  <span className="bold">Materials</span> 60% cotton, 40% polyester
                </div>
                <div className="py-2">
                  <span className="bold">Other Info</span> American heirloom jean shorts
